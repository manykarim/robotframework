...
:   Sets the version of the documented library or resource. The default value for test libraries is [defined in the source code](../extending/creating-test-libraries.md#library-version).

`-P, --pythonpath <path>`{.option}
:   Additional locations where to search for libraries and resources similarly as when [running tests](../executing-tests/configuring-execution.md#using-pythonpath-option).
...
and [resource files](#resource-file-documentation). [Creating test libraries](../extending/creating-test-libraries.md#creating-test-libraries) and [resource files](../creating-test-data/resource-files.md#resource-files) is
described in more details elsewhere in the User Guide.

### Python libraries

The documentation for Python libraries that use the [static library API](../extending/creating-test-libraries.md#creating-keywords)
...
[Markdown](../creating-test-data/index.md#syntax),  [reStructuredText](#markdown-documentation-syntax), [HTML](#html-documentation-syntax) and [plain text](#plain-text-documentation-syntax). The format to use can
be specified in [library source code](../extending/creating-test-libraries.md#documentation-format) using the `ROBOT_LIBRARY_DOC_FORMAT`
...
on the first and second level [section headers](../creating-test-data/test-data-syntax.md#test-data-sections) (e.g. `= Section =`,
...
supported syntax can be from the [Markdown format](../appendices/documentation-formatting.md#markdown-format) appendix.
...
Markdown [reference links](../appendices/documentation-formatting.md#reference-links) like `Linking to [My Keyword] works` are used
instead.
...
With Markdown linking is done using normal Markdown [reference links](../appendices/documentation-formatting.md#reference-links) like
...
Robot Framework's [own documentation format](../appendices/documentation-formatting.md#robot-framework-format) and [Markdown format](../appendices/documentation-formatting.md#markdown-format) both support
...
documented using [Google Style](../creating-test-data/test-data-syntax.md#style) documentation conventions. Also tags can be
listed in documentation similarly.

!!! note
    Support to explicitly document arguments, return values and exceptions
    using the [Google Style](../creating-test-data/test-data-syntax.md#style) is new in Robot Framework 7.5.
...
If a shown type is [automatically converted](../extending/creating-test-libraries.md#supported-conversions), has a [custom converter](../extending/creating-test-libraries.md#custom-argument-converters) or is
...
Robot Framework supports [Google style](../creating-test-data/test-data-syntax.md#style) argument documentation:
...
fine. When documenting [user keyword arguments](../creating-test-data/creating-user-keywords.md#user-keyword-arguments), it is possible to omit `${}`,
`@{}` and `&{}` decoration.
...
also during execution and can be used for [argument conversion](../extending/creating-test-libraries.md#argument-conversion).
...
[documentation formatting](../appendices/documentation-formatting.md#documentation-formatting) possibilities, [internal linking](#internal-linking), and so on.
