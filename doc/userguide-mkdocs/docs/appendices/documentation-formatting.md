...
- [Suite](../creating-test-data/creating-test-suites.md#suite-documentation) and [test](../creating-test-data/creating-test-cases.md#test-case-documentation)
  documentations use Robot Frameworks own custom format.
- Library and keyword documentation processed by [Libdoc](../supporting-tools/libdoc.md#libdoc) can be written using
  Robot Framework format, Markdown, reStructuredText, HTML and plain text.
- [Error messages](../extending/creating-test-libraries.md#error-messages) support plain text  and HTML.
...
Starting from Robot Framework 7.5, Markdown is supported by [Libdoc](../supporting-tools/libdoc.md#libdoc) and can
...
automatically based on the used [section headers](../creating-test-data/test-data-syntax.md#test-data-sections) so that the two highest
...
!!! note
    [Libdoc](../supporting-tools/libdoc.md#libdoc) supports the same `%TOC%` marker also when
    [creating table of contents](../supporting-tools/libdoc.md#creating-table-of-contents) with the Robot Framework custom format.
