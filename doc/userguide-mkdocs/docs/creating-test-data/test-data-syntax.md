...
- A test case file automatically creates a [test suite](creating-test-suites.md#creating-test-suites) containing
  the test cases in that file.
- A directory containing test case files forms a higher-level test
  suite. Such a [suite directory](creating-test-suites.md#suite-directories) has suites created from test
...
- Test suite directories can have a special [initialization file](creating-test-suites.md#suite-initialization-files)
  configuring the created test suite.

In addition to this, there are:

- [Test libraries](using-test-libraries.md#using-test-libraries) containing the lowest-level keywords.
- [Resource files](resource-files.md#resource-files) with [variables](variables.md#variables) and higher-level [user keywords](creating-user-keywords.md#creating-user-keywords).
...
| Section | Used for |
| --- | --- |
| Settings | 1) Importing [test libraries](using-test-libraries.md#using-test-libraries), [resource files](resource-files.md#resource-files) and [variable files](variable-files.md#variable-files).<br>2) Defining metadata for [test suites](creating-test-suites.md#creating-test-suites) and [test cases](creating-test-cases.md#creating-test-cases). |
...
parsed [can be configured](../executing-tests/configuring-execution.md#selecting-files-to-parse). [Resource files](resource-files.md#resource-files) can use the `.robot`{.file}
...
other extensions [can be enabled](../executing-tests/configuring-execution.md#selecting-files-to-parse) by using either `--parseinclude`{.option}
...
`.json`{.file} extension, you need to [configure which files are parsed](../executing-tests/configuring-execution.md#selecting-files-to-parse).
...
[joined together with the newline character](../appendices/documentation-formatting.md#newlines) to ease creating multiline
values.
...
that allowed translation of [section headers](#test-data-sections), [settings](../appendices/available-settings.md#available-settings),
[Given/When/Then prefixes](#enabling-languages) used in Behavior Driven Development (BDD), and
[true and false strings](creating-test-cases.md#behavior-driven-style) used in automatic Boolean argument conversion.
...
This section explains how to [activate languages](../extending/creating-test-libraries.md#supported-conversions), what [built-in languages](#built-in-languages)
