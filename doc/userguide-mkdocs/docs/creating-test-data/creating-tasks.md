...
the [test case section](creating-test-cases.md#settings-in-the-test-case-section). In the [setting section](creating-test-cases.md#test-case-related-settings-in-the-setting-section) it is possible to use
