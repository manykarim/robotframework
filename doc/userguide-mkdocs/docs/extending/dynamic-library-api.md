...
creates a [custom 'robot_name' attribute](creating-test-libraries.md#setting-custom-name) on the decorated method.
...
| One or more [positional argument](../creating-test-data/creating-test-cases.md#positional-argument) | List of strings containing argument names. | `['argument']`<br>`['arg1', 'arg2', 'arg3']` |
...
| [Positional-only arguments](creating-test-libraries.md#positional-only-arguments) | Arguments before the `/` marker. New in Robot Framework 6.1. | `['posonly', '/']`<br>`['p', 'q', '/', 'normal']` |
| [Variable number of arguments](../creating-test-data/creating-test-cases.md#variable-number-of-arguments) (varargs) | Argument after possible positional arguments has a `*` prefix | `['*varargs']`<br>`['argument', '*rest']`<br>`['a', 'b=42', '*c']` |
...
| [Free named arguments](../creating-test-data/creating-test-cases.md#free-named-arguments) (kwargs) | Last arguments has `**` prefix. Requires `run_keyword` to [support free named arguments](#named-only-arguments-with-dynamic-libraries). | `['**named']`<br>`['a', ('b', 42), '**c']`<br>`['*varargs', '**kwargs']`<br>`['*', 'kwo', '**kws']` |
...
important. They are needed for [named argument support](#named-argument-syntax-with-dynamic-libraries) and the [Libdoc](../supporting-tools/libdoc.md#libdoc)
...
objects than strings, Robot Framework can do [automatic argument conversion](creating-test-libraries.md#implicit-argument-types-based-on-default-values)
based on them.
...
works exactly like with [static libraries](creating-test-libraries.md#argument-conversion), but how the type information
...
the [@keyword decorator](creating-test-libraries.md#specifying-argument-types-using-keyword-decorator). Type information can be specified using actual
...
[argument default values](creating-test-libraries.md#implicit-argument-types-based-on-default-values). Earlier this did not work with the dynamic API
